scoreboard players operation @s[scores={silentban=1..}] ban.player = @s[scores={silentban=1..}] silentban

scoreboard players set @s silentban 0

scoreboard players set @a[scores={silentban=1..},tag=!banning] banreason 0
...
tag @s[scores={silentban=0},tag=!banning] add banning
...
execute as @a[scores={banreason=1..}] if score @s banreason matches 1.. if entity @s as @a if score @s pid = @a[limit=1,sort=random,tag=permission.minecraft.ban,tag=banning] ban.player if entity @s[tag=!permission.minecraft.ban.exempt] run summon marker 0 0 0 {Tags:["banned"]}
execute as @a[scores={banreason=1..}] if score @s banreason matches 1.. if entity @s as @a if score @s pid = @a[limit=1,sort=random,tag=permission.minecraft.ban,tag=banning] ban.player if entity @s[tag=!permission.minecraft.ban.exempt] run scoreboard players operation @e[tag=!processed,tag=banned] pid = @s pid
...
execute as @s run scoreboard players operation @s silentban = @s ban.player
